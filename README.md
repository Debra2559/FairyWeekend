...
<p align="center">
  ...
  <a href="#-%E9%97%AE%E9%A2%98%E4%B8%8E%E8%A7%A3%E6%B3%95">问题与解法</a> •
  <a href="#-%E6%A0%B8%E5%BF%83%E5%8A%9F%E8%83%BD">核心功能</a> •
  <a href="#-%E6%8A%80%E6%9C%AF%E6%9E%B6%E6%9E%84">技术架构</a> •
  <a href="#-%E6%9C%AC%E5%9C%B0%E5%BC%80%E5%8F%91">本地开发</a> •
...
周末有了难得的空档，想带家人出去走走，或者和朋友聚一聚——这个念头人人都有，但真正从「想出门」变成「出了门」，中间横着一道隐形的门槛。不是没有平台，不是没有内容，而是没有任何一个地方能把这件事从头到尾帮你做完。

### 解法

「今日人设 · TodayPersona」把「想出门」到「出了门」缩短为 4 步，平均决策时间从传统「20 分钟刷点评」压缩到「3 分钟出门」。

| 步骤 | 方式 | 动作 | 对应页面 | 核心价值 |
|------|------|------|----------|----------|
| ① 抽卡 | AI 帮我挑 | 表达想法或者根据引导回答 | 告诉 TodayPersona 你此刻的状态，AI 对话引导，推荐最匹配的人设 | |
| | 我自己选 | 挑选一个最合眼缘的卡 | 浏览 16 张人设卡画廊，找到今天最像自己的那张 | |
| | 让命运决定 | 一切交给命运，抽就完了 | 塔罗式扇形抽卡，把决策权交给运气 | |
| ② 遇卡 | 遇见你的人设卡 | 符合你的状态？or 是你想成为的人？ | 查看今日身份、Mood、Mission、Story、BGM……准备启动属于今天你的那页故事 | |
| ③ 路线 | Agent 制定路线 | 查看你专属的路线图 | 故事引导 + 今日路线图 + 一键套餐&预定 + 支持改路线 | |
| ④ 记录 | 集章 + 故事连载 | 收进「我的连载」 | 把一次消费变成可收藏、可分享的长期资产 | |

在算法疲劳的时代，把「出门」重新做成一件值得期待的事。

我们不和点评争「最好吃的店」，我们只回答一个问题——
